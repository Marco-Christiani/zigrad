...
pub fn build(b: *std.Build) void {
    ...
    const zigrad_mod = b.addModule("zigrad", .{
        .root_source_file = b.path("src_experimental/root.zig"),
        .target = target,
        .optimize = optimize,
        // dlopen + friends
        .link_libc = true,
    ...
    zigrad_mod.addIncludePath(b.path("src_experimental"));
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("src_experimental/main.zig"),
            .target = target,
            .optimize = optimize,
    ...
    exe.linkLibC();
    exe.root_module.addIncludePath(b.path("src_experimental"));
    ...
    const exe_m2 = b.addExecutable(.{
        .name = "zigrad-pjrt-m2",
        .root_module = b.createModule(.{
            .root_source_file = b.path("src_experimental/m2_matmul.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
            .imports = &.{.{ .name = "zigrad", .module = zigrad_mod }},
    ...
    exe_m2.root_module.addIncludePath(b.path("src_experimental"));
    ...
    const exe_m2_fusion = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("src_experimental/m2_fusion.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
    ...
    exe_m2_fusion.root_module.addIncludePath(b.path("src_experimental"));
    ...
    const exe_m4 = b.addExecutable(.{
        .name = "zigrad-pjrt-m4",
        .root_module = b.createModule(.{
            .root_source_file = b.path("src_experimental/m4_matmul.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
            // NOTE: SDK artifacts were built against libstdc++ ABI, we will NOT link cpp with this flag. See linkMlirStablehloCapi().
    ...
    exe_m4.root_module.addIncludePath(b.path("src_experimental"));
    ...
    const exe_m4_custom = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("src_experimental/m4_custom_call.zig"),
            .target = target,
            .optimize = optimize,
            .link_libc = true,
            // NOTE: SDK artifacts were built against libstdc++ ABI, we will NOT link cpp with this flag. See linkMlirStablehloCapi().
    ...
    exe_m4_custom.root_module.addIncludePath(b.path("src_experimental"));
