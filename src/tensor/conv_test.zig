...
pub fn main() !void {
    ...
    // try conv.weights.data.set(&[_]usize{ 0, 0 }, 1);
    // try conv.weights.data.set(&[_]usize{ 0, 1 }, 0);
    // try conv.weights.data.set(&[_]usize{ 0, 2 }, 0);
    // try conv.weights.data.set(&[_]usize{ 0, 3 }, 1);
    ...
    // const TrainerT = Trainer(f32, ops.mse_loss);
